...
(function () {
  ...
  // Собрано по образцу референса: тренировка 1 совпадает с примером (80/82.5/82.5/85/85 при 1ПМ=100).
  // Дальше — своя волна процентов, если пришлёшь точные цифры с оригинала — подгоню 1-в-1.
  var ROUND_STEP = 2.5;
  ...
  var BENCH_PROGRESSION_TEMPLATE = [
    ...
    [ { pct: 82.5, reps: 5, type: 'normal' }, { pct: 85, reps: 4, type: 'normal' }, { pct: 85, reps: 4, type: 'normal' }, { pct: 87.5, reps: 3, type: 'normal' }, { pct: 110, reps: 1, type: 'negative' } ],
    [ { pct: 85, reps: 5, type: 'normal' }, { pct: 87.5, reps: 4, type: 'normal' }, { pct: 87.5, reps: 4, type: 'normal' }, { pct: 90, reps: 3, type: 'normal' }, { pct: 112.5, reps: 1, type: 'negative' } ],
    [ { pct: 87.5, reps: 4, type: 'normal' }, { pct: 90, reps: 4, type: 'normal' }, { pct: 90, reps: 3, type: 'normal' }, { pct: 92.5, reps: 3, type: 'normal' }, { pct: 115, reps: 1, type: 'negative' } ],
    [ { pct: 87.5, reps: 4, type: 'normal' }, { pct: 90, reps: 3, type: 'normal' }, { pct: 90, reps: 3, type: 'normal' }, { pct: 92.5, reps: null, type: 'test' } ],
    [ { pct: 90, reps: 4, type: 'normal' }, { pct: 92.5, reps: 3, type: 'normal' }, { pct: 92.5, reps: 3, type: 'normal' }, { pct: 95, reps: 2, type: 'normal' }, { pct: 117.5, reps: 1, type: 'negative' } ],
    [ { pct: 90, reps: 4, type: 'normal' }, { pct: 92.5, reps: 3, type: 'normal' }, { pct: 92.5, reps: 2, type: 'normal' }, { pct: 95, reps: null, type: 'test' } ],
    [ { pct: 92.5, reps: 3, type: 'normal' }, { pct: 95, reps: 3, type: 'normal' }, { pct: 95, reps: 2, type: 'normal' }, { pct: 97.5, reps: 2, type: 'normal' }, { pct: 120, reps: 1, type: 'negative' } ],
    [ { pct: 92.5, reps: 3, type: 'normal' }, { pct: 95, reps: 2, type: 'normal' }, { pct: 95, reps: 2, type: 'normal' }, { pct: 97.5, reps: null, type: 'test' } ],
    [ { pct: 95, reps: 3, type: 'normal' }, { pct: 97.5, reps: 2, type: 'normal' }, { pct: 97.5, reps: 2, type: 'normal' }, { pct: 100, reps: 1, type: 'normal' }, { pct: 122.5, reps: 1, type: 'negative' } ],
    [ { pct: 95, reps: 3, type: 'normal' }, { pct: 97.5, reps: 2, type: 'normal' }, { pct: 97.5, reps: 1, type: 'normal' }, { pct: 100, reps: null, type: 'test' } ],
    [ { pct: 97.5, reps: 2, type: 'normal' }, { pct: 100, reps: 2, type: 'normal' }, { pct: 100, reps: 1, type: 'normal' }, { pct: 102.5, reps: 1, type: 'normal' }, { pct: 125, reps: 1, type: 'negative' } ],
    [ { pct: 100, reps: 2, type: 'normal' }, { pct: 102.5, reps: 1, type: 'normal' }, { pct: 102.5, reps: 1, type: 'normal' }, { pct: 105, reps: 1, type: 'normal' }, { pct: 127.5, reps: 1, type: 'negative' } ],
    [ { pct: 80, reps: 3, type: 'normal' }, { pct: 90, reps: 2, type: 'normal' }, { pct: 95, reps: 1, type: 'normal' }, { pct: 100, reps: 1, type: 'normal' }, { pct: 110, reps: 1, type: 'record' } ]
  ];
